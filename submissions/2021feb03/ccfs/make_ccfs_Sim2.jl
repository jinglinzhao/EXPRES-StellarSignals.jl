...
verbose = true
 ...
 target_subdir = "Sim2"   # USER: Replace with directory of your choice
  fits_target_str = "Sim2"
...
linelist_for_ccf_fn_w_path = joinpath(pkgdir(EchelleCCFs),"data","masks",line_list_filename)
 ...
 #CSV.write(joinpath("pennstate","Sim2","Sim2_line_list_espresso.csv"), line_list_espresso)
...
title!("Sim2: CCF - <CCF>, ESPRESSO mask + SNR weights")
#savefig("ccf_heatmaps_Sim2.png")
...
#xlims!(ccf_mid_velocity-3*line_width_50,ccf_mid_velocity+3*line_width_50)
savefig("ccf_heatmaps_Sim2_espresso_msf=4.0.png")
...
xlabel!("v (m/s)")
ylabel!("Order index")
title!("Sim2: CCF_" *string(obs_id) * ", ESPRESSO mask + SNR weights")
#xlims!(ccf_mid_velocity-RvSpectMLBase.max_bc,ccf_mid_velocity+RvSpectMLBase.max_bc)
xlims!(ccf_mid_velocity-3*line_width_50,ccf_mid_velocity+3*line_width_50)
