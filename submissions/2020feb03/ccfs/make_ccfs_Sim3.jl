...
verbose = true
 ...
 target_subdir = "Sim3"   # USER: Replace with directory of your choice
  fits_target_str = "Sim3"
...
linelist_for_ccf_fn_w_path = joinpath(pkgdir(EchelleCCFs),"data","masks",line_list_filename)
 ...
 #CSV.write(joinpath("pennstate","Sim3","Sim3_line_list_espresso.csv"), line_list_espresso)
...
title!("Sim3: CCF - <CCF>, ESPRESSO mask + SNR weights")
#savefig("ccf_heatmaps_Sim3.png")
...
#xlims!(ccf_mid_velocity-3*line_width_50,ccf_mid_velocity+3*line_width_50)
savefig("ccf_heatmaps_Sim3_espresso_msf=4.0.png")
...
xlabel!("v (m/s)")
ylabel!("Order index")
title!("Sim3: CCF_" *string(obs_id) * ", ESPRESSO mask + SNR weights")
#xlims!(ccf_mid_velocity-RvSpectMLBase.max_bc,ccf_mid_velocity+RvSpectMLBase.max_bc)
xlims!(ccf_mid_velocity-3*line_width_50,ccf_mid_velocity+3*line_width_50)
